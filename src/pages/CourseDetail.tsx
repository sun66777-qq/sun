...
const courses = [
  ...
  },
  {
    ...
    content: "# 供应链数据分析课程大纲\n\n## 📋 课程基本信息\n- **课程名称**：供应链数据分析\n- **课程类型**：专业核心课\n- **适用专业**：商务数据分析与应用\n- **学期**：高职大二第二学期\n- **先修课程**：Python基础、数据分析技术\n\n## 🎯 课程目标\n1. 掌握供应链管理的基本概念和原理\n2. 了解供应链数据分析的方法和工具\n3. 能够应用数据分析技术解决供应链管理问题\n4. 提高供应链的效率和效益\n5. 培养供应链数据思维和分析能力\n\n## 📚 课程内容\n\n### 第一章 供应链管理概述\n- 1.1 供应链管理的概念和重要性\n- 1.2 供应链的结构和流程\n- 1.3 供应链管理的挑战和机遇\n- 1.4 供应链管理的发展趋势\n\n### 第二章 供应链数据\n- 2.1 供应链数据的类型和来源\n- 2.2 供应链数据的质量和管理\n- 2.3 供应链数据的集成和共享\n- 2.4 供应链大数据的特点和挑战\n\n### 第三章 供应链绩效分析\n- 3.1 供应链绩效指标体系\n- 3.2 供应链绩效评估方法\n- 3.3 供应链绩效分析案例\n- 3.4 绩效分析结果的应用\n\n### 第四章 供应链优化\n- 4.1 库存优化分析\n- 4.2 物流网络优化\n- 4.3 供应商选择和评估\n- 4.4 供应链风险分析\n- 4.5 供应链优化案例\n\n### 第五章 供应链数据分析工具\n- 5.1 Excel在供应链分析中的应用\n- 5.2 Python在供应链分析中的应用\n- 5.3 专业供应链分析软件\n- 5.4 供应链可视化工具\n\n## 📅 课程进度表\n\n| 周次 | 教学内容 | 实验内容 | 作业 |\n|------|----------|----------|------|\n| 第1周 | 供应链管理概述 | 供应链结构分析 | 完成供应链案例分析报告 |\n| 第2周 | 供应链数据 | 供应链数据收集与整理 | 完成数据收集方案设计 |\n| 第3周 | 供应链绩效指标 | 绩效指标计算与分析 | 完成绩效指标分析报告 |\n| 第4周 | 供应链绩效评估 | 绩效评估工具使用 | 完成绩效评估案例分析 |\n| 第5周 | 库存优化 | 库存模型建立与分析 | 完成库存优化方案设计 |\n| 第6周 | 物流网络优化 | 物流网络规划工具 | 完成物流网络优化案例 |\n| 第7周 | 供应商选择与评估 | 供应商评估模型 | 完成供应商评估方案 |\n| 第8周 | 供应链风险分析 | 风险评估工具使用 | 完成风险分析报告 |\n| 第9周 | 供应链分析工具 | Python在供应链分析中的应用 | 完成供应链分析项目 |\n| 第10周 | 复习与考试 | - | 准备期末考试 |\n\n## 👨‍🏫 教学方法\n1. **理论讲解**：讲解供应链管理和数据分析的基本概念\n2. **案例分析**：分析真实供应链数据分析案例\n3. **实践操作**：通过软件工具进行供应链分析\n4. **项目实践**：完成供应链数据分析项目\n5. **小组讨论**：讨论供应链管理问题和解决方案\n\n## 📊 评估方式\n\n| 评估项目 | 权重 | 评估标准 |\n|----------|------|----------|\n| 平时作业 | 30% | 按时完成作业，分析深入 |\n| 实验报告 | 30% | 实验记录完整，结果准确 |\n| 期末考试 | 40% | 理论知识掌握扎实，实践能力强 |\n\n## 📚 参考资料\n1. 《供应链管理》，苏尼尔·乔普拉，中国人民大学出版社\n2. 《供应链数据分析》，蔡建湖，机械工业出版社\n3. 《物流与供应链管理》，马丁·克里斯托弗，电子工业出版社\n4. 《供应链优化与分析》，David Simchi-Levi，清华大学出版社\n\n## 💡 学习建议\n1. 了解供应链管理的基本概念和流程\n2. 掌握数据分析的基本方法和工具\n3. 关注供应链管理的最新发展和趋势\n4. 多分析真实供应链案例，积累实践经验\n5. 培养系统思维，从整体角度分析供应链问题" 
  },
  {
    id: "database",
    name: "数据库原理与应用",
    ...
    content: "# 数据库原理与应用课程大纲\n\n## 📋 课程基本信息\n- **课程名称**：数据库原理与应用\n- **课程类型**：专业基础课\n- **适用专业**：商务数据分析与应用\n- **学期**：高职大一第二学期\n- **先修课程**：计算机基础\n\n## 🎯 课程目标\n1. 掌握数据库的基本概念和原理\n2. 熟悉关系型数据库的设计和管理\n3. 能够使用SQL语句进行数据操作\n4. 了解数据库在数据分析中的应用\n5. 培养数据库设计和管理的能力\n\n## 📚 课程内容\n\n### 第一章 数据库概述\n- 1.1 数据库的基本概念\n- 1.2 数据库管理系统\n- 1.3 数据库的发展历程\n- 1.4 数据库的应用领域\n- 1.5 数据库系统的组成\n\n### 第二章 关系数据库基础\n- 2.1 关系模型\n- 2.2 关系代数\n- 2.3 关系数据库设计\n- 2.4 数据库规范化\n- 2.5 关系完整性约束\n\n### 第三章 SQL语言\n- 3.1 SQL的基本概念\n- 3.2 数据定义语言（DDL）\n- 3.3 数据操纵语言（DML）\n- 3.4 数据查询语言（DQL）\n- 3.5 数据控制语言（DCL）\n- 3.6 高级SQL查询\n\n### 第四章 数据库设计\n- 4.1 需求分析\n- 4.2 概念结构设计\n- 4.3 逻辑结构设计\n- 4.4 物理结构设计\n- 4.5 数据库实施和维护\n- 4.6 数据库设计案例\n\n### 第五章 数据库应用开发\n- 5.1 数据库连接技术\n- 5.2 数据库应用程序开发\n- 5.3 数据库安全性\n- 5.4 数据库性能优化\n- 5.5 数据库备份和恢复\n\n## 📅 课程进度表\n\n| 周次 | 教学内容 | 实验内容 | 作业 |\n|------|----------|----------|------|\n| 第1周 | 数据库概述 | 数据库系统安装与配置 | 完成数据库系统安装报告 |\n| 第2周 | 关系数据库基础 | 关系模型练习 | 完成关系代数运算练习 |\n| 第3周 | 数据库规范化 | 规范化练习 | 完成数据库规范化作业 |\n| 第4周 | SQL基础 | SQL语句练习 | 完成SQL基础练习 |\n| 第5周 | SQL查询 | 高级查询练习 | 完成SQL查询作业 |\n| 第6周 | 数据库设计 | 概念结构设计 | 完成数据库概念设计 |\n| 第7周 | 数据库设计 | 逻辑结构设计 | 完成数据库逻辑设计 |\n| 第8周 | 数据库应用开发 | 数据库连接技术 | 完成数据库应用开发练习 |\n| 第9周 | 数据库安全与优化 | 数据库性能优化 | 完成数据库优化方案 |\n| 第10周 | 复习与考试 | - | 准备期末考试 |\n\n## 👨‍🏫 教学方法\n1. **理论讲解**：讲解数据库的基本概念和原理\n2. **实践操作**：通过SQL语句练习掌握数据库操作\n3. **项目实践**：完成数据库设计和开发项目\n4. **小组合作**：小组协作完成数据库设计任务\n5. **案例分析**：分析真实数据库应用案例\n\n## 📊 评估方式\n\n| 评估项目 | 权重 | 评估标准 |\n|----------|------|----------|\n| 平时作业 | 30% | 按时完成作业，SQL语句正确 |\n| 实验报告 | 30% | 实验记录完整，设计合理 |\n| 期末考试 | 40% | 理论知识掌握扎实，实践能力强 |\n\n## 📚 参考资料\n1. 《数据库系统概论》，王珊，高等教育出版社\n2. 《SQL必知必会》，Alan Beaulieu，人民邮电出版社\n3. 《数据库设计与开发》，周立柱，清华大学出版社\n4. 《MySQL必知必会》，Alan Beaulieu，人民邮电出版社\n\n## 💡 学习建议\n1. 理解数据库的基本概念和原理\n2. 多练习SQL语句，掌握数据库操作技能\n3. 学习数据库设计的方法和技巧\n4. 关注数据库技术的最新发展\n5. 结合实际应用，提高数据库应用能力" 
  }
];
